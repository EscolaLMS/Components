...
<React.Fragment>
  <GlobalThemeProvider>
    <Title level={4}>Zmiana tła do widoczności skrzydełek karty</Title>
  ...
  <ThemeTester childrenListStyle={{ display: "block", background }}>
    <Card style={{ marginTop: 30 }}>
      <Title level={3}>Jak zbudowane sa protezy</Title>
      <Text type="secondary">Logistyka / Zasady pracy</Text>
      <div style={{ display: "flex", alignItems: "center", marginBottom: 20 }}>
        ...
        />{" "}
        <Text size={"14"} style={{ margin: "0 10px" }}>
          po
        </Text>
        <IconTitle level={6} title="Material to download" icon={<Icon1 />} styles={{ container: { margin: 0 } }} />
      </div>
      <div style={{ display: "flex", gap: 30 }}>
        <Button style={{ marginRigth: 20 }}>Jak to działa?</Button>
        <Button mode="outline">Jak to działa?</Button>
      </div>
    </Card>
    <Card style={{ marginTop: 40 }}>
      <Text style={{ margin: 0 }}>With Wings</Text>
    </Card>
    <Card hideWings style={{ marginTop: 20 }}>
