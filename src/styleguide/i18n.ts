  ...
  en: {
    translation: {
      ...
      "Course.markAsFinished": "Mark as finished",
       "CourseCard.lession_one": "{{count}} lession",
        "CourseCard.lession_other": "{{count}} lessions",
  ...
  pl: {
    translation: {
      ...
      "Course.markAsFinished": "Oznacz jako ukończone",
        "CourseCard.lession_one": "{{count}} lekcja",
        "CourseCard.lession_few": "{{count}} lekcje",
        "CourseCard.lession_many": "{{count}} lekcji",
