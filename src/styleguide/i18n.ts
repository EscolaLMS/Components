...
export const resources = {
  en: {
    translation: {
      ...
      "CourseTopNav.addBookmark": "Add bookmark",
      "CourseTopNav.addBookmarkMobile": "Bookmark",
  ...
  pl: {
    translation: {
      ...
      "CourseTopNav.addBookmark": "Dodaj zakładkę",
      "CourseTopNav.addBookmarkMobile": "Zakładka",
